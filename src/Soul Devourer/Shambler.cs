...
namespace SoulDev
{
    class ShamblerEnemy : EnemyAI
    {
        ...
        // stamina mechanics
        protected float stamina = 120f; // shamblers use stamina to chase the player
...
#pragma warning restore 0649
        ...
        public IEnumerator DoSneakyStab()
        {
            if (getNearestPlayer())
            {
                ...
                if (stabbedPlayer != null)
                {
                    DmgPlayerClientRpc(stabbedPlayer.NetworkObject.NetworkObjectId, 20);
                }
        ...
        public void updateEntranceChance()
        {
            ...
            if (mostRecentPlayer)
            {
                if (mostRecentPlayer == this.isOutside) { chanceToLocateEntrancePlayerBonus = 1; }
